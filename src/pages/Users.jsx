    ...
    contact: (
      <div className="flex items-center gap-3">
        <div className="relative group bg-green-100 rounded-full p-2 cursor-pointer">
          ...
          <div className="absolute top-full mt-1 left-1/2 -translate-x-1/2 bg-black text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-50 pointer-events-none">
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-0 justify-between items-start md:items-center mb-6">
        <div className="w-full md:flex-1 md:max-w-xl">
          <SearchInput onSearch={setSearchQuery} placeholder="Search users..." />
        </div>
        <Button
          variant="primary"
