                  ...
                  {actions.length > 0 && (
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div className="relative flex justify-end">
                        ...
                        {activeMenu === rowIndex && (
                          <div
                            className="absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-lg ring-1  z-50
                            ...
                            <div className="py-1">
                              {actions.map((action, index) => (
                                <button
                                  ...
                                  className={`flex items-center px-4 py-2 text-sm w-full text-left hover:bg-gray-100 focus:outline-none focus:bg-gray-100 cursor-pointer ${
