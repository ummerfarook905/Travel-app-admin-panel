...
const CustomerInfo = ({ customer, bookingDetails, type }) => {
  return (
    <div
      className="bg-[#003f2f] text-white p-5 rounded-xl w-full h-fit"
      style={{ marginTop: window.innerWidth >= 1024 ? "-25px" : "10px" }}
    >
      {/* Customer Profile Section */}
      <div className="flex items-center space-x-3 mb-4">
        {customer.photo ? (
          ...
          <div className="w-10 h-10 rounded-full bg-gray-500 flex items-center justify-center text-white font-bold border-2 border-white">
